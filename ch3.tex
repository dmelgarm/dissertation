...
\begin{figure}[!ht] 
  \centering
  \includegraphics[width=0.99\linewidth]{./figures/ch3/toki_final.pdf}
...
\begin{figure}[!ht] 
  \centering
  \includegraphics[width=0.99\linewidth]{./figures/ch3/elmay_final.pdf}
...
\subsection{Violation of the Point Source Assumption}
