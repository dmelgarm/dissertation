...
\begin{figure}[!ht] 
  \centering
  \includegraphics[width=0.99\linewidth]{./figures/ch4/snapshots_10s.pdf}
...
\begin{figure}[ht]
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption[Subfault source-time functions]{%
	Subfault source-time functions (STFs). The 90\% confidence intervals are indicated by the white line and the solid grey hatched area. The coloring under the STFs represents the pseudo rupture velocity. The red star indicates the hypocenter. All STFs are plotted at the same scale.
      }\end{minipage}},rotate=90,center}
      \includegraphics[scale=0.55]{./figures/ch4/tiles_small.pdf}%
  \end{adjustbox}
  \label{fig_tiles}
\end{figure}
